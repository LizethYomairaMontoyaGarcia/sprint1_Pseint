//1. Desarrollar un programa que me permita solicitar los datos de 5 personas, incluyendo: nombre, 
//apellido, teléfono, correo, y la dirección debe ser en el siguiente formato: ciudad, barrio, y calle. 
//Esta información debo almacenarla en un array de objetos. Posteriormente, debo solicitar al usuario que 
//nombre no existe en el arreglo, debería mostrar un mensaje que diga: El usuario no existe.
...
console.log(persona['age'])//29
const key = 'nombre';
console.log(persona[key])//lizeth
